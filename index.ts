...
if (pinAnswer.pin == myPin) {
    ...
    if (amountAns.amount <= myBalance) {
      ...
      console.log(
        chalk.bold.blueBright(
          `You have succesfully withdrawn... Now your remaining balance is: ${myBalance}`
        )
      );
    } else {
      console.log(
        chalk.bold.redBright(`Sorry!!!!! You have insufficient balance`)
      );
    }
  }
  // if user select fast cash option
    ...
    if (FastcashAns.amount <= myBalance) {
      ...
      console.log(
        chalk.bold.blueBright(
          `You have succesfully transacted your amount.... Now your remaining balance is: ${myBalance}`
        )
      );
    } else {
      console.log(
